...
export class FtpTreeDataProvidere implements vscode.TreeDataProvider<FtpNode>, vscode.TextDocumentContentProvider {
...
export class FtpExplorer {
	...
	constructor(context: vscode.ExtensionContext) {
		...
		const treeDataProvider = new FtpTreeDataProvidere(ftpModel);
